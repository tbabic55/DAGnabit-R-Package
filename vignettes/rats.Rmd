...
nodes_path <- system.file("extdata/examples/rats/nodes.csv", package = pkg)
edges_path <- system.file("extdata/examples/rats/edges.csv", package = pkg)
if (!nzchar(nodes_path)) nodes_path <- "inst/extdata/examples/rats/nodes.csv"
if (!nzchar(edges_path)) edges_path <- "inst/extdata/examples/rats/edges.csv"
...
if (!file.exists(nodes_path) || !file.exists(edges_path)) {
  ...
  knitr::kable(
    data.frame(
      ...
      nodes  = c(nrow(rats_nodes),  nrow(rats_nodes_fixture)),
      edges  = c(nrow(rats_edges),  nrow(rats_edges_fixture))
    ),
    caption = "Node/edge counts: parser vs Rats fixture."
  )
}
```
